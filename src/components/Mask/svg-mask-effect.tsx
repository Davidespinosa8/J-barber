    ...
    >
      ...
      >
        ...
        <div
          ...
          className="max-w-4xl mx-auto text-center text-white  text-4xl font-bold relative z-20 font-Techmono"
        >
          {children}
        </div>
      </motion.div>

      <div className="w-full h-full flex items-center justify-center  text-white font-Oswald">
        {revealText}
      </div>
    </motion.div>
  );
